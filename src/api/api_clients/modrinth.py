...
class ModrinthApiClient:
    ...
    def search_project(query: str, minecraft_version: str) -> list[str]:
        with Client() as client:
            r = client.get("https://api.modrinth.com/v2/search", params={"query": query, "facets": json.dumps([[f"versions:{minecraft_version}"],["project_type:plugin"]])})
            return r.json()


ModrinthApiClient.search_project("luckperms", "1.16.5")