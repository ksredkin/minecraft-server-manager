...
from src.api.services.eula_service import get_eula_service, EulaService
...
def set_eula(accept_eula: bool = True, eula_service: EulaService = Depends(get_eula_service)) -> JSONResponse:
